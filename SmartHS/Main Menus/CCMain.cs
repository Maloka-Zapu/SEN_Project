...
namespace SmartHS
{
    public partial class CCMain : Form
    {
        
        public CCMain(string empID)
        {
            InitializeComponent();
            eID = empID;
        }
        ...
        {
            ViewPhoneRecords vpr = new ViewPhoneRecords(eID);
            vpr.Show();
            this.Close();
        }
        ...
        {
            CallCentre c = new CallCentre(eID);
            c.Show();
            this.Close();
        }

        private void CCMain_Load(object sender, EventArgs e)
        {
            //Style
            btnCreate.BackColor = Color.FromArgb(160, ColorTranslator.FromHtml("#033594"));
            btnViewLogs.BackColor = Color.FromArgb(160, ColorTranslator.FromHtml("#033594"));
